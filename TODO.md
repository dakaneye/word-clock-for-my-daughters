...
- [ ] **Add a microSD slot cutout to the back panel SVG** — audio updates may happen more than once a year; requiring back-panel removal for SD swaps is annoying. Small rectangular slot (~12 × 2.5 mm) aligned to the SD slot on the HW-125 breakout. CR2032 swaps are rare enough (5-10 years) that battery access through the fully-removed panel is acceptable.
